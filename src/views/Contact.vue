<template>
  <div class="relative isolate bg-white">
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      ...
      >
        <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
          ...
          <p class="mt-6 text-lg/8 text-gray-600">
            By Saving one child life, we save an entire generation.
          </p>
      ...
      <div>
        <img src="/contact.jpg" class="h-full w-auto" alt="" />
      </div>
      <!-- <form
        action="#"
        method="POST"
      ...
      >
        <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            <div>
              ...
              <div class="mt-2.5">
                <input
                  ...
                  class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-[#f26421]"
                />
              </div>
            </div>
            <div>
          ...
          <div class="mt-8 flex justify-end">
            <button
              type="submit"
              class="rounded-md bg-[#f26421] px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#f26421]"
            >
              Send message
            </button>
          </div>
